...
import com.duboomom.spring.test.jstl.model.Member;
...
public class JSTLController {
	...
	@GetMapping("/test02/music")
	public String test02MusicRanking(Model model) {
		...
		model.addAttribute("musicRankig", musicRanking);
		
		return "jstl/test02music";
	}
	
	@GetMapping("/test02/membership")
	public String test02Membership(Model model) {
